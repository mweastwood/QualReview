...
\item \textbf{Describe the mechanisms by which cosmic rays gain and lose energy. Which mechanisms
      ...
      \newthought{Now consider processes} through which charged particles can lose energy.
      Longair only seems to treat these processes in the context of electrons\sidenote{
        Perhaps this is because electrons are lower mass, experience more acceleration,
        and hence suffer more radiative losses than protons and heavy nuclei.
      }, so keep in mind
      that the following expressions may only be valid for electrons.
      \begin{itemize}
      \item Ionization

            The formula for ionization losses of an electron is pretty complicated\sidenote{
                See Longair Equation 5.36
            }.  In this process, the high energy electron strips electrons from other atoms it passes
      ...
      \item Bremsstrahlung
            ...
            Bremsstrahlung is treated in Section~\ref{sec:bremsstrahlung}, although to do this
            rigorously we would need to
            treat the case of the energy losses for a single ultra-relativistic electron.
            Summarizing Longair chapter 6.6, the spectrum is flat out to frequency
            $\nu\approx (\gamma-1)m_e c^2/h$.  That is, the cutoff frequency is where the energy
            of the photon is greater than the kinetic energy of the electron.
            The actual intensity of the radiation (at a given frequency) is independent of
            $\gamma$, so the total power radiated is proportional to $\gamma$ because the
            bandwidth scales with $\gamma$:
            \begin{dmath}
                -\frac{\d E}{\d t} \propto Z^2nE
            \end{dmath}.
            In chapter 16.2.2, Longair provides expressions for the decay time in a fully ionized
            hydrogen plasma and in a fully screened neutral hydrogen gas cloud.  To the order
            of magnitude level, it doesn't make a difference\sidenote{
                Only the Gaunt factor is affected.
            }.  Therefore, we can write
            \begin{dmath}
                \tau_{\rm ionization} \sim 10^8 \frac{1\,{\rm cm}^{-3}}{n}\,{\rm yr}
            \end{dmath}.

      \item Adiabatic losses

            If the particles are contained to an expanding volume\sidenote{
                Longair chapter 15.7 discusses how cosmic rays are confined within our own
                galaxy.  Scattering by irregularities in the magnetic field, Alfv\'{e}n waves,
                and hydromagnetic waves all impede the motion of the particles.  These are not
                present in regions where the ISM is predominantly neutral.  Therefore, cosmic
                rays are capable of diffusing rapidly through regions of neutral material,
                but can only propagate at the Alfv\'{e}n speed in fully ionized plasmas.
            }.  The timescale for adiabatic losses is shown by Longair (chapter 16.2.3) to be
            the timescale for the expansion of the confinement region.  That is
            \begin{dmath}
                \tau_{\rm adiabatic} \sim \frac{R}{\d R/\d t}
            \end{dmath}.
            Therefore adiabatic losses are important if the particles are confined for a
            time comparable to the expansion time.  If particles have always been confined to an
            expanding region, adiabatic losses are always important.
      ...
      \item Inverse Compton scattering
            ...
            The timescale for cooling through inverse Compton scattering off the CMB\sidenote{
                $T\approx2.73\,{\rm K}$
            } is therefore
            \begin{dmath}
      ...
      \newthought{Finally, let's consider} processes that accelerate high energy particles.
      \begin{itemize}
      \item Electric fields
            ...
            fields can be produced nonetheless\sidenote{
                This is how magnetic fields can be used to do work.  For instance during
                magnetic reconnection the energy that is in the magnetic fields is used to do
                work on charged particles.  This is possible because the changing magnetic field
                induces an electric field which actually does the work.
            }.
      ...
      \item Fermi acceleration
            ...
            off magnetic mirrors\sidenote{
                In a slowly varying magnetic field, the magnetic moment $\mu = IA$ of a gyrating
                particle is conserved, where $I$ is the current carried by the particle in its
                orbit and $A$ is the area interior to its orbit.
                We know the frequency of the orbit (nonrelativistic) is $\omega = eB/m_e c$
                and the radius is $r = m_evc\sin\alpha/eB$.
                Therefore $\mu = (e\omega/2\pi)(\pi r^2)\sim \sin\alpha/B^2$.
                So as the magnetic field gets larger, the pitch angle $\alpha$ must also
                grow.  When $\sin\alpha = 1$, the particle reflects and reverses direction.
                Hence regions of large magnetic fields can act as mirrors for charged particles.
            }.  Magnetic flux freezing suggests that these magnetic mirrors are denser regions
            ...
            the rate of energy gain becomes\sidenote{
                An extra factor of $1/2$ comes from averaging over pitch angle.
            }
            \begin{dmath}
                \frac{\d E}{\d t} = \frac43 \left(\frac{V^2}{cL}\right) E \nolinebreak
                                  = \alpha E
            \end{dmath}.
            After doing a bit of math involving the diffusion-loss equation\sidenote{
                See Longair Equation 7.41.
            }, one can show that this naturally leads to a power-law distribution for the
            energy such that
            \begin{dmath}
      ...
      \item Shock acceleration
            ...
            It can be shown that this naturally leads to a power law of index 2.  That is
            \begin{dmath}
                N(E)\,\d E \propto E^{-2}\,\d E
            \end{dmath}.

      \end{itemize}

      We end with a small discussion on the specific locations where these processes operate.
      
      Todo: Solar flares, Pulsars, Supernovae remnants
