...
reionization (as indicated by WMAP data).  The first stars were concentrated 
in the largest density fluctuations, leading to ``clumpy'' reionization.  
Feedback from these stars may have prevented further star formation in their 
host galaxies, leading to a partial recombination.  The eventual formation of 
population II stars then completed reionization at around z$\sim6$ (as 
indictated by QSO data).  Population II stars formed out of gas enriched by 
the first generation, so they were more similar to stars today (more metal poor 
though).  The state of reioniztion has been studied out to z$\sim6$ using 
QSOs.  To observe the H in the IGM when it was still neutral, experiments 
are underway to observe the redshifted $21$ cm line at long radio wavelengths 
(yeah Michael).  
