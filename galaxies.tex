...
\item \textbf{Define two-body relaxation and estimate its time scale in (a) a globular cluster; (b)
      ...
      \end{equation}
      If you want to consider all directions, you can put in a factor of $3$, since this is just for the flux of masses moving past the central mass in one direction.
