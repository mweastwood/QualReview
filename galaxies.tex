...
\begin{equation}
Q \thicksim \frac{\kappa \sigma}{3G\Epsilon}
\end{equation}

In this equation, $\sigma$ is the stellar velocity dispersion, $\Epsilon$ is the local surface density, and $\kappa$ is the epicyclic frequency (the frequency at which radially displaced particles will oscillate).
